...
pymodule.o: pymodule.c pymodule.h loop.h dataref.h
...
raberix.xpl: main.o menu.o pymodule.o loop.o dataref.o
	$(CC) -shared -o raberix.xpl main.o menu.o pymodule.o loop.o dataref.o $(PYTHON_LDLAGS)
