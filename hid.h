...
LINKED_LIST_TYPE(HidDevice) get_hid_device_list(void); // the caller is the owner of the returnng (null-terminated) list and must destroy it with destroy_hid_device_list()
